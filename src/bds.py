...
def bds(fun, x0, options=None):
    ...
    output_alpha_hist = options.get("output_alpha_hist", get_default_constant("output_alpha_hist"))

    # Initialize alpha_hist if output_alpha_hist is true.
    alpha_hist = None
    if output_alpha_hist:
        try:
            ...
            print("alpha_hist will not be included in the output due to memory limits.")
